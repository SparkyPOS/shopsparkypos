    ...
    <section class="send_query bg-white contact_form">
            <div class="row">
                <div class="col-xl-6 col-md-6">
                    ...
                    <input type="text"  class="primary_input3 style4 radius_3px mb_20" placeholder="{{ __('payment_gatways.bank_name') }}" name="bank_name" value="{{@old('bank_name')}}">
                ...
                <div class="col-xl-6 col-md-6">
                    ...
                    <input type="text"  name="branch_name" class="primary_input3 style4 radius_3px mb_20" placeholder="{{ __('payment_gatways.branch_name') }}" value="{{@old('branch_name')}}">
            ...
            <div class="row mb-20">
                <div class="col-xl-6 col-md-6">
                    ...
                    <input type="text"  class="primary_input3 style4 radius_3px mb_20" placeholder="{{ __('payment_gatways.account_number') }}" name="account_number" value="{{@old('account_number')}}">
                ...
                <div
                    ...
                    <input type="text"  name="account_holder" class="primary_input3 style4 radius_3px mb_20" placeholder="{{ __('payment_gatways.account_holder') }}" value="{{@old('account_holder')}}">
            ...
            <div class="row  mb-20">
                ...
                <div
                    ...
                    <input type="file"  name="image" class="primary_input3 style4 radius_3px pd_12">

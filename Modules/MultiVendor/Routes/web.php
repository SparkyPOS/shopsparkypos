...
Route::get('stripe-connect/callback', 'SellerController@stripeAuthCallback')->name('stripe.connect.callback');
...
Route::middleware(['auth','seller'])->prefix('seller')->as('seller.')->group(function() {
    ...
    Route::get('connect', 'SellerController@stripeConnect')->name('stripe.connect');
